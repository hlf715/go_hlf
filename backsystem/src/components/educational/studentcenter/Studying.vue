    ...
    <div id="Studying">
        <el-row class="margin-bottom15">
            ...
            <el-col :span="12">
                ...
                <el-button class="float-r" type="danger" size="small" icon="el-icon-s-operation">新生报名</el-button>
                <el-button class="float-r" type="danger" size="small" icon="el-icon-s-operation" plain>自助绑定家长端</el-button>
            </el-col>
        </el-row>
        ...
        <el-row class="margin-bottom15">
            <el-col :span="24">
                ...
                <el-dropdown trigger="click" class="margin-right5 cr-pointer">
                    <span class="el-dropdown-link">
                        学员生日<i class="el-icon-arrow-down el-icon--right"></i>
                    </span>
                    <el-dropdown-menu slot="dropdown">
                        <el-dropdown-item icon="el-icon-plus">黄金糕</el-dropdown-item>
                    </el-dropdown-menu>
                ...
                <el-dropdown trigger="click" class="margin-right5 cr-pointer">
                    <span class="el-dropdown-link">
                        学校<i class="el-icon-arrow-down el-icon--right"></i>
                    </span>
                    <el-dropdown-menu slot="dropdown">
                        <el-dropdown-item icon="el-icon-plus">黄金糕</el-dropdown-item>
                    </el-dropdown-menu>
                </el-dropdown>
                <el-checkbox v-model="isLack" class="margin-right5">欠课</el-checkbox>
                <el-radio-group v-model="radio_isDevide" class="margin-right5">
                    <el-radio :label="3">待分班</el-radio>
                    <el-radio :label="6">已分班</el-radio>
                </el-radio-group>
                <el-checkbox v-model="isRecess" class="margin-right5">已休课</el-checkbox>
                <el-checkbox v-model="isBinding" class="margin-right5">未绑定服务号通知</el-checkbox>
