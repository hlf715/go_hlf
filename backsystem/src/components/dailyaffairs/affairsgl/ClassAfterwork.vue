<template>
    <div id="ClassAfterwork">
        <el-row class="margin-bottom15">
            ...
            <el-col :span="12">
                <el-button class="float-r" type="danger" size="small" icon="el-icon-more-outline" @click="FunOpenafterwork">作业设置</el-button>
            </el-col>
        </el-row>
        <el-row class="margin-bottom15">
            <el-col :span="24">
                ...
                <el-dropdown trigger="click" class="margin-right5 cr-pointer">
                    <span class="el-dropdown-link">
                        老师选择<i class="el-icon-arrow-down el-icon--right"></i>
                    </span>
                    <el-dropdown-menu slot="dropdown">
                        <el-dropdown-item icon="el-icon-plus">黄金糕</el-dropdown-item>
                    </el-dropdown-menu>
                ...
                <el-dropdown trigger="click" class="margin-right5 cr-pointer">
                    <span class="el-dropdown-link">
                        上课主题<i class="el-icon-arrow-down el-icon--right"></i>
                    </span>
                    <el-dropdown-menu slot="dropdown">
                        <el-dropdown-item icon="el-icon-plus">黄金糕</el-dropdown-item>
                    </el-dropdown-menu>
                ...
                <el-radio-group v-model="radio_isCutoff" class="margin-right5">
                    <el-radio :label="3">未截止</el-radio>
                    <el-radio :label="6">已截止</el-radio>
                </el-radio-group>
                <el-divider direction="vertical"></el-divider>
                <el-radio-group v-model="radio_classtype" class="margin-right5">
        ...
        <el-row class="margin-bottom15">
            <el-col :span="24">
                <el-table :data="tableData" row-key="id" fit highlight-current-row style="width: 100%">
                    ...
                    <el-table-column label="布置时间" width="180">
                        <template slot-scope="{row}">
                            <span>{{ row.name }}</span>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column label="点评人数" width="100">
                        <template slot-scope="{row}">
                            <span>{{ row.name }}</span>
                        </template>
                    </el-table-column>
                    <el-table-column label="未交人数" width="100">
                        <template slot-scope="{row}">
                            <span>{{ row.name }}</span>
                        </template>
                    </el-table-column>
        ...
        <afterworkset ref="afterworkset"></afterworkset>
    </div>
</template>
<script>
    import {mapState,mapGetters,mapMutations,mapActions} from 'vuex'
    import afterworkset from '@/dialog/dailyaffairs/affairsgl/afterworkset'
    export default{
        name:'ClassAfterwork',
        components:{
            afterworkset
        ...
        methods:{
            FunOpenafterwork(){
                let child = this.$refs.afterworkset
                child.dialogAfterworkset.isOpen = true
            }
        }
    }
</script>
