<template>
    <div id="commentset">
        <el-dialog width="720px" :title="dialogCommentset.title" :visible.sync="dialogCommentset.isOpen" :close-on-click-modal="false">
            ...
            <span slot="footer" class="dialog-footer">
                <el-button @click="dialogCommentset.isOpen = false">取 消</el-button>
                <el-button type="primary">确 定</el-button>
            </span>
           

            <el-dialog width="720px" :title="dialogCommentset.innerTitle" :visible.sync="dialogCommentset.innerIsopen" append-to-body :close-on-click-modal="false">
                ...
                <span slot="footer" class="dialog-footer">
                    ...
                    <el-button @click="dialogCommentset.innerIsopen = false">取 消</el-button>
                    <el-button type="primary">确 定</el-button>
                </span>
            </el-dialog>
        </el-dialog>
...
<script>
    export default {
        ...
        methods:{
            FunOpeninner(){
                this.dialogCommentset.innerIsopen = true
            },
            FunTableCheck(val) {
