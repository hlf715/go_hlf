<template>
    <div id="showset">
        <el-dialog width="720px" :title="dialogShowset.title" :visible.sync="dialogShowset.isOpen" :close-on-click-modal="false">
            ...
            <span slot="footer" class="dialog-footer">
                <el-button @click="dialogShowset.isOpen = false">取 消</el-button>
                <el-button type="primary">确 定</el-button>
            </span>
           

            <el-dialog width="720px" :title="dialogShowset.innerTitle" :visible.sync="dialogShowset.innerIsopen" append-to-body :close-on-click-modal="false">
                ...
                <span slot="footer" class="dialog-footer">
                    ...
                    <el-button @click="dialogShowset.innerIsopen = false">取 消</el-button>
                    <el-button type="primary">确 定</el-button>
                </span>
            </el-dialog>
        </el-dialog>
...
<script>
    export default {
        ...
        methods:{
            FunOpeninner(){
                this.dialogShowset.innerIsopen = true
            },
            FunTableCheck(val) {
